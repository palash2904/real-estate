...
export class AppService {
  ...
  public getPropertyTypes(){
    return [ 
      ...
      { id: 2, name: 'House' },
      { id: 3, name: 'Apartment' },
      { id: 4, name: 'Commercial Premises' },
      { id: 5, name: 'Commercial Warehouse' },
      { id: 6, name: 'Condominium House' },
      { id: 7, name: 'Land/Lot' },
      { id: 8, name: 'Industrial Warehouse' },
      { id: 9, name: 'All' },
    ]
  }
//I want to...: Buy, rent, bank auction
  public getPropertyStatuses(){
    return [ 
      { id: 1, name: 'Buy' },
      { id: 2, name: 'Rent' },
      { id: 3, name: 'Bank Auction' },
      // { id: 1, name: 'For Sale' },
      // { id: 2, name: 'For Rent' },
